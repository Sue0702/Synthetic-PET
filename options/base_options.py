...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='/nifti_files',
        ...
        parser.add_argument('--netG', type=str, default='ResUnetPlusPlus',
                            help='specify generator architecture [ResUnetPlusPlus|resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='cttopet',
                            help='chooses how datasets are loaded. [unaligned | cttopet | aligned | single | colorization]')
        ...
        parser.add_argument('--no_flip', action='store_true',
                            help='if specified, do not flip the images for data augmentation')  # I added but default 'store_true'
    ...
    def gather_options(self):
        ...
        if model_option_setter is not None:
        ...
        if dataset_option_setter is not None:
    ...
    def print_options(self, opt):
        ...
        print(f"suffix value: {opt.suffix}")  # 添加这行代码打印 suffix 的值
        message += '----------------- End -------------------'
        print(message)
